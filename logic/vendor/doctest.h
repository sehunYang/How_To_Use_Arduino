...
//
// doctest v2.4.12 — single-header C++ test framework
// Source: https://github.com/doctest/doctest/releases/download/v2.4.12/doctest.h
// Upstream: https://github.com/doctest/doctest
// License: MIT — Copyright (c) 2016-2023 Viktor Kirilov (notice retained below)
//
// Vendored rather than fetched at test time so the L5 logic harness stays
// runnable offline and pinned to one known version.
