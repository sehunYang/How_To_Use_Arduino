...
export const pendulumLayout: ReadableLayout = {
  ...
  wires: [
    ...
    wire('scl-uno', 'SCL', 'uno:A5', 'breadboard:7t.a', 'yellow', { x: 300, y: 360 }, [['h', 20], ['v', -90], ['h', -140], ['v', -10]]),
    ...
    wire('power-ina', '5V', 'ina219:VCC', 'breadboard:tp.15', 'red', { x: 600, y: -130 }, [['h', -35], ['v', 35], ['h', 10]]),
    wire('ground-ina', 'GND', 'ina219:GND', 'breadboard:tn.15', 'black', { x: 600, y: -100 }, [['v', 55], ['h', -10]]),
    wire('sda-ina', 'SDA', 'ina219:SDA', 'breadboard:15t.b', 'green', { x: 720, y: -100 }, [['h', 15], ['v', 75], ['h', 5]]),
    wire('scl-ina', 'SCL', 'ina219:SCL', 'breadboard:17t.b', 'yellow', { x: 720, y: -130 }, [['h', 35], ['v', 95], ['h', -10]]),

    wire('power-tsl', '5V', 'tsl2591:VCC', 'breadboard:tp.25', 'red', { x: 900, y: -130 }, [['h', -35], ['v', 35], ['h', 10]]),
    wire('ground-tsl', 'GND', 'tsl2591:GND', 'breadboard:tn.25', 'black', { x: 900, y: -100 }, [['v', 55], ['h', -10]]),
    wire('sda-tsl', 'SDA', 'tsl2591:SDA', 'breadboard:25t.b', 'green', { x: 1020, y: -100 }, [['h', 15], ['v', 75], ['h', 5]]),
    wire('scl-tsl', 'SCL', 'tsl2591:SCL', 'breadboard:27t.b', 'yellow', { x: 1020, y: -130 }, [['h', 35], ['v', 95], ['h', -10]]),
