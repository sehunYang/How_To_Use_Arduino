...
export const phase7OutputExamples: Recipe[] = [
  createPhase7Recipe({
    ...
    procedure: '기록을 시작하기 전에 가장 밝은 단계에서 조도값이 최댓값에 붙어 더 오르지 않는지 확인하세요. 붙어 있으면 그 구간은 버려야 하므로, 센서를 조금 뒤로 물려 눈금이 살아나는 자리를 찾습니다.',
  ...
  createPhase7Recipe({
    ...
    procedure: '한 바퀴를 돌린 뒤 명령한 각도와 각도기로 읽은 각도를 단계마다 짝지어 적으세요. 0도와 180도 끝에서 특히 어긋나면 그 개체가 실제로 낼 수 있는 범위를 적어 두고, 다음 바퀴부터는 그 안쪽만 씁니다.',
