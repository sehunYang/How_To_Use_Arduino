...
export const sensors: Sensor[] = [
  ...
  },
  {
    ...
    pins: [
      ...
      { name: 'SCL', kind: 'i2c' },
      { name: 'SDA', kind: 'i2c' },
      { name: 'RST', kind: 'digital' },
      { name: 'A0', kind: 'digital' },
      { name: 'A1', kind: 'digital' },
      { name: 'A2', kind: 'digital' },
      ...Array.from({ length: 8 }, (_, channel) => [
        { name: `SD${channel}`, kind: 'i2c' as const },
        { name: `SC${channel}`, kind: 'i2c' as const },
      ]).flat(),
    ],
    currentDrawMa: 1,
