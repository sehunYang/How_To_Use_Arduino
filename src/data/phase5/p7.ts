...
export const p7Recipe = createProjectRecipe({
  ...
  procedure: 'TSL2591을 패널 면에 함께 붙여 패널과 같은 각도로 기울어지게 하세요. 부하는 패널 정격에 맞는 작은 저항(수십 Ω)을 골라 고정하고, 광원-패널 거리를 고정한 채 패널 법선과 광선 사이 각도를 일정 간격으로 바꾸세요. 각 각도에서 값이 안정된 뒤 전압×전류를 구하고 광량도 함께 기록하세요.',
