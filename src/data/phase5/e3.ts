...
export const e3Recipe = createProjectRecipe({
  ...
  science: '열손실률이 물과 주변의 온도 차에 비례한다고 보면 $T-T_a=(T_0-T_a)e^{-kt}$입니다. 증발, 자연대류, 용기 열용량과 실내 기류는 $k$를 바꿉니다.',
  applicationGuide: '용기 재질, 뚜껑 유무 또는 물의 양을 바꾸고 $\\ln(T-T_a)$-시간 그래프의 기울기로 냉각 상수를 비교하세요.',
  troubleshooting: [
