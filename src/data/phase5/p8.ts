...
export const p8Recipe = createProjectRecipe({
  ...
  procedure: '주변광을 먼저 재고 각 조도값에서 빼세요. 광원 중심과 TSL2591 수광면을 같은 축에 수직으로 맞추고, 광원 필라멘트와 같은 평면에 평평한 카드를 세워 초음파 반사판으로 쓰세요. 전구 유리면처럼 굽은 면은 초음파 표적으로 부적합합니다. 거리를 넓은 범위에서 바꾸세요.',
