...
export const p8Recipe = createProjectRecipe({
  ...
  procedure: '주변광을 먼저 재고 각 조도값에서 빼세요. 광원 중심과 TSL2591 수광면을 같은 축에 수직으로 맞춘 뒤 거리를 충분히 넓은 범위에서 바꾸세요.',
  science: '크기를 무시할 수 있는 등방성 점광원은 에너지가 구면에 퍼져 세기가 1/r²에 비례합니다. 가까운 거리의 유한한 광원, 반사광, 센서 포화와 초음파 영점 거리는 이 관계를 왜곡합니다.',
  applicationGuide: '보정한 조도×거리²가 일정한지 표로 확인하고, 로그-로그 그래프 기울기가 -2에 가까운지 비교하세요.',
