...
export const e6Recipe = createProjectRecipe({
  ...
  troubleshooting: [
    ...
    { symptom: '센서 순서가 재부팅 뒤 바뀌거나 하나가 -127°C임', cause: '인덱스 순서는 고정 식별자가 아니며 신호선을 기본 HIGH 상태로 유지하는 저항이 부족하거나 접촉이 불량하면 일부 주소를 읽지 못할 수 있습니다.', fix: '실험 전 각 센서의 64비트 주소를 기록해 주소로 읽고 DATA-5V 사이 4.7 kΩ 풀업 저항을 확인하세요.' },
  ],
})
