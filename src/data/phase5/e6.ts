...
export const e6Recipe = createProjectRecipe({
  ...
  science: '1-Wire 센서는 한 선을 공유하지만 각자 고유 주소로 구분됩니다. 변환 명령을 동시에 보낸 뒤 순서대로 읽으면 시차가 작습니다. 배선이 길어질수록 버스 정전용량과 잡음 영향이 커집니다.',
  applicationGuide: '물의 위·중간·아래 또는 단열재 양쪽에 센서를 놓아 시간에 따른 온도 구배와 열전달 방향을 비교하세요.',
  troubleshooting: [
    contactTroubleshooting,
    { symptom: '센서 순서가 재부팅 뒤 바뀌거나 하나가 -127°C임', cause: '인덱스 순서는 고정 식별자가 아니며 풀업 부족 또는 접촉 불량으로 일부 주소를 읽지 못할 수 있습니다.', fix: '실험 전 각 센서의 64비트 주소를 기록해 주소로 읽고 DATA-5V 사이 4.7 kΩ 풀업을 확인하세요.' },
  ],
})
