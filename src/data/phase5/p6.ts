...
export const p6Recipe = createProjectRecipe({
  ...
  procedure: '센서와 자석의 중심축을 맞추고 자석에 붙지 않는 재질의 자로 거리를 재세요. 자석이 없을 때 영점을 기록한 뒤 같은 극 방향을 유지하며 거리를 늘려 각 지점에서 평균값을 구하세요.',
  science: '자석에서 충분히 멀면 막대자석의 중심축 방향 자기장은 대략 거리의 세제곱에 반비례합니다. 가까운 거리에서는 자석 크기를 점으로 볼 수 없고 센서의 측정 범위를 넘어 값이 최댓값에 머물 수 있어 단순 법칙이 맞지 않습니다.',
  applicationGuide: '로그-로그 그래프의 기울기를 구하고 가까운 점을 제외할 때 -3에 가까워지는지 확인해보세요.',
  troubleshooting: [
    contactTroubleshooting,
    { symptom: '자석을 뒤집어도 값의 부호가 바뀌지 않음', cause: '영점 설정이 틀렸거나 센서가 자기장에 가장 잘 반응하는 방향과 자석 축이 어긋났습니다.', fix: '자석을 치우고 zeroAdc를 다시 정한 뒤 센서 면에 수직으로 N극과 S극을 번갈아 대세요.' },
  ],
})
