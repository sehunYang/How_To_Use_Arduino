...
export const p4Recipe = createProjectRecipe({
  ...
  procedure: '아두이노와 브레드보드, 두 센서를 수레에 실어 배선이 끌리지 않게 하고, HC-SR04는 수레 뒤쪽에서 고정 반사판(벽)을 향하게 하세요. 경사각과 수레 질량을 재고 같은 출발점에서 반복하며, 수평 구간에서만 거리 미분으로 얻은 속도와 MPU6050 가속도의 경향이 일치하는지 확인하세요. 경사면 위에서는 센서가 중력 성분을 함께 읽어 어긋나는 것이 정상입니다.',
