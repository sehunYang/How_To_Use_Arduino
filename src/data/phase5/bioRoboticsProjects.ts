...
export const biologyProjectRecipes: Recipe[] = [
  ...
  project({
    ...
    connections: [
      ...
      { from: 'CDS.VCC', to: 'UNO.5V', color: 'red', text: 'CDS 모듈 VCC를 5V에 연결하세요.' },
      { from: 'CDS.GND', to: 'UNO.GND', color: 'black', text: 'CDS 모듈 GND를 공통 GND에 연결하세요.' },
      { from: 'CDS.AO', to: 'UNO.A0', color: 'blue', text: 'CDS 아날로그 출력 AO를 A0에 연결하세요.' },
    ],
...
export const roboticsProjectRecipes: Recipe[] = [
  ...
  project({
    ...
    connections: [
      { from: 'CDS_1.AO', to: 'UNO.A0', color: 'blue', text: '왼쪽 CDS의 AO를 A0에 연결하세요.' },
      { from: 'CDS_2.AO', to: 'UNO.A1', color: 'green', text: '오른쪽 CDS의 AO를 A1에 연결하세요.' },
      { from: 'CDS_1.VCC', to: 'UNO.5V', color: 'red', text: '왼쪽 CDS 모듈 VCC를 5V에 연결하세요.' },
      { from: 'CDS_2.VCC', to: 'UNO.5V', color: 'red', text: '오른쪽 CDS 모듈 VCC를 5V에 연결하세요.' },
      { from: 'CDS_1.GND', to: 'UNO.GND', color: 'black', text: '왼쪽 CDS 모듈 GND를 공통 GND에 연결하세요.' },
      { from: 'CDS_2.GND', to: 'UNO.GND', color: 'black', text: '오른쪽 CDS 모듈 GND를 공통 GND에 연결하세요.' },
      { from: 'DRIVER.IN1', to: 'UNO.D2', color: 'orange', text: '왼쪽 모터 방향 입력을 D2에 연결하세요.' },
      { from: 'DRIVER.IN2', to: 'UNO.D3', color: 'purple', text: '오른쪽 모터 방향 입력을 D3에 연결하세요.' },
  ...
  project({
    ...
    connections: [
      ...
      { from: 'HC-SR501.GND', to: 'UNO.GND', color: 'black', text: 'PIR GND를 공통 GND에 연결하세요.' },
      { from: 'HC-SR501.OUT', to: 'UNO.D2', color: 'yellow', text: 'PIR OUT을 D2에 연결하세요.' },
      { from: 'CDS.VCC', to: 'UNO.5V', color: 'red', text: 'CDS VCC를 5V에 연결하세요.' },
      { from: 'CDS.GND', to: 'UNO.GND', color: 'black', text: 'CDS GND를 공통 GND에 연결하세요.' },
      { from: 'CDS.AO', to: 'UNO.A0', color: 'blue', text: 'CDS AO를 A0에 연결하세요.' },
      { from: 'RELAY.VCC', to: 'UNO.5V', color: 'red', text: '릴레이 모듈 VCC를 5V에 연결하세요.' },
      { from: 'RELAY.GND', to: 'UNO.GND', color: 'black', text: '릴레이 모듈 GND를 공통 GND에 연결하세요.' },
