...
export const biologyProjectRecipes: Recipe[] = [
  ...
  project({
    ...
    tunable: { anchor: 'darkThreshold', name: '어두움 기준값', hint: '설치 장소의 낮과 밤에 아날로그 전압을 숫자로 바꾼 값(ADC 값)을 먼저 기록해 중간값으로 정하세요.' },
  ...
  project({
    ...
    tunable: { anchor: 'targetLux', name: '목표 조도', hint: '센서의 측정 범위를 넘지 않고 식물에 무리가 없는 범위에서 설정하세요.' },
