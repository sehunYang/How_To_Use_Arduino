...
export const roboticsProjectRecipes: Recipe[] = [
  ...
  project({
    ...
    connections: [
      { from: 'CDS_LEFT.AO', to: 'UNO.A0', color: 'blue', text: '왼쪽 CDS의 AO를 A0에 연결하세요.' },
      { from: 'CDS_RIGHT.AO', to: 'UNO.A1', color: 'green', text: '오른쪽 CDS의 AO를 A1에 연결하세요.' },
      { from: 'CDS_LEFT+RIGHT.VCC', to: 'UNO.5V', color: 'red', text: '두 CDS 모듈 VCC를 5V에 연결하세요.' },
      { from: 'CDS_LEFT+RIGHT.GND', to: 'UNO.GND', color: 'black', text: '두 CDS 모듈 GND를 공통 GND에 연결하세요.' },
      { from: 'DRIVER.IN1', to: 'UNO.D2', color: 'orange', text: '왼쪽 모터 방향 입력을 D2에 연결하세요.' },
      { from: 'DRIVER.IN2', to: 'UNO.D3', color: 'purple', text: '오른쪽 모터 방향 입력을 D3에 연결하세요.' },
