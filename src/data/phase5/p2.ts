...
export const p2Recipe = createProjectRecipe({
  ...
  procedure: '시리얼 모니터 속도를 115200으로 맞추세요. 질량과 기준 높이를 먼저 재고 같은 출발점에서 세 번 원시 CSV를 기록하세요. 기록을 마친 뒤 센서 가속도를 그대로 속도로 보지 말고, 정지 구간의 영점을 보정한 운동축 성분을 시간 적분하여 속도와 에너지를 계산하세요.',
