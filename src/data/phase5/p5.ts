...
export const p5Recipe = createProjectRecipe({
  ...
  procedure: '시리얼 모니터 속도를 115200으로 맞추세요. 센서 x축을 진행 방향과 맞추고 정지 상태에서 tilt_deg로 경사각을 기록한 뒤, 출발선과 도착선 사이 거리를 자로 재어 두세요. 수레를 밀지 않고 놓아 기록에서 출발 순간과 도달 순간(스파이크)을 읽어 $a=2s/\\Delta t^2$으로 평균 가속도를 구하고, 각 각도에서 세 번 반복하세요. 굴러가는 동안 센서가 직접 읽는 가속도 값은 마찰 성분만 남으므로 가속도로 쓰지 마세요.',
