...
export const p5Recipe = createProjectRecipe({
  ...
  science: '마찰이 없으면 경사면 방향 가속도는 g sinθ입니다. 실제 수레에서는 구름 마찰과 센서 축 오정렬 때문에 작아지며, 정지 시 중력 성분과 운동 중 관성 성분을 구분해야 합니다.',
  applicationGuide: 'sinθ를 가로축, 측정 가속도를 세로축으로 그려 기울기와 절편에서 g와 마찰 효과를 추정하세요.',
