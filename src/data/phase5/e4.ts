...
export const e4Recipe = createProjectRecipe({
  ...
  procedure: '센서를 직사광선, 빗물, 선풍기 바람과 문 여닫기의 급격한 압력 변화에서 피하세요. 설치 높이를 바꾸지 않고 일정 간격으로 기록하며 가까운 공식 관측소 자료도 남기세요. 하루 이상 기록하려면 컴퓨터 절전을 끄고 시리얼 모니터를 계속 열어 두세요. 창을 닫거나 보드를 다시 연결하면 시계가 0부터 다시 시작되므로, 그때는 파일을 나눠 저장하고 실제 시각을 메모하세요.',
