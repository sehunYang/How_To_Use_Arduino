...
export const p3Recipe = createProjectRecipe({
  ...
  science: '공기 저항을 무시하면 위치는 시간의 이차함수입니다. HC-SR04의 사각, 음속의 온도 의존성, 물체 기울어짐, 초음파 잔향 때문에 60 ms 아래로 줄이기 어려운 측정 간격이 주된 오차입니다. 1 m 낙하는 약 0.45초이므로 표본이 7개 남짓입니다. 낙하 거리를 늘려 표본 수를 확보하세요.',
