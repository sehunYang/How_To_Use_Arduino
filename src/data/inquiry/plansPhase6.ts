...
export const phase6Plans: Record<string, InquiryPlan> = {
  ...
  'p10-eight-point-light-field': {
    ...
    setup: [
      ...
      '**2. 배선하기**를 끝까지 마친 뒤, 각 센서의 SDA와 SCL이 같은 번호의 SD와 SC 자리에 들어갔는지 여덟 쌍 모두 확인합니다.',
      'USB 케이블을 연결하고 시리얼 모니터를 9600 baud로 엽니다.',
  ...
  'ph17-ohms-law': {
    ...
    setup: [
      ...
      '**2. 배선하기**를 끝까지 마친 뒤, 전류가 INA219의 VIN+에서 저항을 지나 VIN-로 흐르는지 손가락으로 짚어 확인합니다.',
      'USB 케이블을 연결하고 시리얼 모니터를 9600 baud로 엽니다.',
  ...
  'ph18-series-parallel-resistance': {
    ...
    setup: [
      ...
      '**2. 배선하기**를 끝까지 마친 뒤, INA219가 전원과 저항망 사이에 끼어 있는지 확인합니다.',
      'USB 케이블을 연결하고 시리얼 모니터를 9600 baud로 엽니다.',
  ...
  'ph19-kirchhoff-laws': {
    ...
    setup: [
      ...
      '**2. 배선하기**를 끝까지 마친 뒤 전류가 갈라지는 지점과 다시 만나는 지점을 손가락으로 짚어 확인합니다.',
      'USB 케이블을 연결하고 시리얼 모니터를 9600 baud로 엽니다.',
  ...
  'ph22-battery-internal-resistance': {
    ...
    setup: [
      ...
      '**2. 배선하기**를 끝까지 마친 뒤, 전류가 건전지에서 INA219를 지나 저항으로 흐르는지 확인합니다.',
