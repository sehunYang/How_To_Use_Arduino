...
export interface InquiryPlan {
  ...
  setup: string[]
  /**
   * 전자 부품 밖의 준비물. 실, 추, 스탠드처럼 배선에 이름이 나오지 않아
   * 준비물 화면이 스스로 알아낼 수 없는 것을 적습니다.
   *
   * 한 줄에 하나씩, 크기나 개수를 함께 적습니다. "실"이 아니라 "실 약 1 m",
   * "자"가 아니라 "자 (30 cm 이상)"입니다. 적지 않으면 학생은 탐구 순서까지
   * 읽고 나서야 스탠드가 필요하다는 것을 알게 됩니다.
   */
  apparatus?: string[]
  /**
