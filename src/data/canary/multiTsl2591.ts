...
export const multiTsl2591Recipe: Recipe = {
  ...
  wiring: [
    ...
    { from: 'TCA9548A.VCC', to: 'BB.bp.8', color: 'red', focus: { x: 100, y: 280, w: 140, h: 60 }, text: '멀티플렉서 VCC를 아래쪽 빨간 전원 레일에 연결하세요' },
    { from: 'TCA9548A.GND', to: 'BB.bn.7', color: 'black', focus: { x: 100, y: 340, w: 140, h: 60 }, text: '멀티플렉서 GND를 아래쪽 파란 접지 레일에 연결하세요' },
    { from: 'TSL2591_1.VCC', to: 'BB.bp.3', color: 'red', focus: { x: 300, y: 40, w: 140, h: 60 }, text: '첫 번째 조도센서 VCC를 아래쪽 빨간 전원 레일에 연결하세요' },
    { from: 'TSL2591_1.GND', to: 'BB.bn.4', color: 'black', focus: { x: 300, y: 100, w: 140, h: 60 }, text: '첫 번째 조도센서 GND를 아래쪽 파란 접지 레일에 연결하세요' },
    { from: 'TSL2591_2.VCC', to: 'BB.bp.23', color: 'red', focus: { x: 300, y: 160, w: 140, h: 60 }, text: '두 번째 조도센서 VCC를 아래쪽 빨간 전원 레일에 연결하세요' },
    { from: 'TSL2591_2.GND', to: 'BB.bn.24', color: 'black', focus: { x: 300, y: 220, w: 140, h: 60 }, text: '두 번째 조도센서 GND를 아래쪽 파란 접지 레일에 연결하세요' },
    { from: 'TCA9548A.SDA', to: 'UNO.A4', color: 'green', focus: { x: 500, y: 40, w: 140, h: 60 }, text: '멀티플렉서 SDA를 아두이노 A4에 연결하세요' },
    { from: 'TCA9548A.SCL', to: 'UNO.A5', color: 'yellow', focus: { x: 500, y: 100, w: 140, h: 60 }, text: '멀티플렉서 SCL을 아두이노 A5에 연결하세요' },
    { from: 'TSL2591_1.SDA', to: 'TCA9548A.SD0', color: 'green', focus: { x: 500, y: 160, w: 140, h: 60 }, text: '첫 번째 조도센서 SDA를 멀티플렉서 채널 0의 SD0에 연결하세요' },
    { from: 'TSL2591_1.SCL', to: 'TCA9548A.SC0', color: 'yellow', focus: { x: 500, y: 220, w: 140, h: 60 }, text: '첫 번째 조도센서 SCL을 멀티플렉서 채널 0의 SC0에 연결하세요' },
    { from: 'TSL2591_2.SDA', to: 'TCA9548A.SD1', color: 'green', focus: { x: 500, y: 280, w: 140, h: 60 }, text: '두 번째 조도센서 SDA를 멀티플렉서 채널 1의 SD1에 연결하세요' },
    { from: 'TSL2591_2.SCL', to: 'TCA9548A.SC1', color: 'yellow', focus: { x: 500, y: 340, w: 140, h: 60 }, text: '두 번째 조도센서 SCL을 멀티플렉서 채널 1의 SC1에 연결하세요' },
  ],
  sketch,
  baudRate: 9600,
  tunables: [
