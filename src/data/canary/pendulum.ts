...
진자가 흔들릴 때 위치에너지와 운동에너지가 서로 바뀌며 보존됩니다. MPU6050 센서로 진자의 기울기를 재면 흔들리는 주기를 계산합니다.
...
:::toggle 수식으로 보기 (고등학생)
단진자의 주기는 $T=2\\pi\\sqrt{L/g}$로 근사합니다.
:::`,
  applicationGuide: '진자의 길이를 바꿔가며 측정하면 주기와 길이의 관계가 드러납니다. 추의 무게를 바꿔도 주기가 거의 변하지 않는지도 비교해보세요.',
  troubleshooting: [
    { symptom: '시리얼 모니터에 아무 값도 안 나옴', cause: 'SDA/SCL이 A4/A5에 꽂혔는지 확인이 필요합니다', fix: 'A4=SDA, A5=SCL 배선을 확인하세요' },
